...
for sig1 in ["LF", "HR"]:
    for sig2 in ["ICP", "PRX"]:
        ...
        X_a, labels_a = prepare_data(possibly_file1, possibly_file2, 1)  # label is "0" for possibly
        X_b, labels_b = prepare_data(probably_file1, probably_file2, 0)  # label is "1" for probably
