...
target_path_CLIP = "C:\\Users\\48503\\Desktop\\PSH_patients_for_tests\\RESULTS_2_GROUPS\\ALL"
likely_path_CLIP = "C:\\Users\\48503\\Desktop\\PSH_patients_for_tests\\RESULTS_2_GROUPS\\LIKELY"
unlikely_path_CLIP = "C:\\Users\\48503\\Desktop\\PSH_patients_for_tests\\RESULTS_2_GROUPS\\UNLIKELY"
...
unlikely_ids = set(meta[meta['Probable or Possible PSH'] == 0]['ID'].astype(str).tolist())
...
likely_ids = set(meta[meta['Probable or Possible PSH'] == 1]['ID'].astype(str).tolist())
